...
diabetes_model = pickle.load(open('C:/Users/vimukthi/Desktop/prediction/models/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('C:/Users/vimukthi/Desktop/prediction/models/heart_disease_model.sav', 'rb'))

parkinsons_model = pickle.load(open('C:/Users/vimukthi/Desktop/prediction/models/parkinsons_model.sav', 'rb'))


cancer_model = pickle.load(open('C:/Users/vimukthi/Desktop/prediction/models/cancer_model.sav', 'rb'))
...
if (selected == 'Lung Cancer Prediction'):
    ...
    if st.button('Lung Canser Test Result'):
        ...
        if (cancer_prediction[0] == 1):
            ...
            cancer_diagnosis = 'The person has not lung cancer'
